...
$install_count = \Bitrix\Main\Config\Configuration::getInstance()->get("grom_module_mymodule");


//Получаем объект с последним сообщением об ошибке
...
?>
<?
echo CAdminMessage::ShowMESSAGE(array("MESSAGE"=>Loc::getMessage("GROM_MYMODULE_INSTALL_COUNT").' = '.$install_count["install"],"TYPE"=>"OK"));
?>
<?
//echo \NotPsr4One::getParam("param1");
//echo CAdminMessage::ShowMESSAGE(array("MESSAGE"=>\Grom\Mymodule\NotPsr4One::getParam("param1"),"TYPE"=>"OK"));
?>
